...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/silo0/GitHubDesktop/Assortment_System_Server/build-middleware-Desktop_Qt_6_2_0_GCC_64bit-Debug/LabelLibrary_ext-prefix/src/LabelLibrary_ext'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/silo0/GitHubDesktop/Assortment_System_Server/build-middleware-Desktop_Qt_6_2_0_GCC_64bit-Debug/LabelLibrary_ext-prefix/src/LabelLibrary_ext'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
